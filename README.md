Many thanks to ErikKalkoken to create an amazing solution for datatable filter with dropdown ! I just apply Bootstrap 4 styling and functionality to dropdowns.
